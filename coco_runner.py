...
parser.add_argument('--model-type', type=str, default='coop', choices=['clip', 'coop'],
                    help='对比实验: clip=零样本CLIP, coop=CoOp')
...
def main_coco():
    ...
    # COCO list 里是 train2017/xxx.jpg，所以 data 应为包含 train2017 的目录（即 coco/data/）
    ...
    # checkpoint 保存到项目目录下，避免依赖作者本机路径
    ...
    # load model（对比实验: clip / coop）
    ModelClass = CLIPZeroShot if args['model_type'] == 'clip' else CoopCLIP
    ...
    if args['model_type'] == 'coop' and hasattr(models[0], 'prompt_learner'):
