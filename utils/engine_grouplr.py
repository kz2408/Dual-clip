    ...
    def save_checkpoint(self, models, regular_map, ema_map, epoch, model_name):
        ...
        if ema_map > self.highest_ema_map:
            ...
            if self.highest_ema_model is not None:
                os.remove(os.path.join('/data2/yanjiexuan/checkpoints/RC-Tran/MKT_fs_checkpoint/', self.highest_ema_model))
            ...
            torch.save({
                ...
                'model': 'ema',
                'state_dict': ema_model.module.state_dict(),
            }, os.path.join('/data2/yanjiexuan/checkpoints/RC-Tran/MKT_fs_checkpoint/', self.highest_ema_model))
